...
export const walletTypeConfig: WalletTypeEntry[] = [
  {
    ...
    defaultRules: () => ({ type: 'stamps', totalStamps: 10, reward: 'Un producto gratis', stampIcon: 'check', expiresInDays: null }),
  ...
  },
  {
    ...
    defaultRules: () => ({ type: 'points', pointsLabel: 'puntos', reward: 'Descuento 10%', rewardThreshold: 100, expiresInDays: null }),
  ...
  },
  {
    ...
    defaultRules: () => ({ type: 'cashback', cashbackPercent: 5, currency: 'MXN', expiresInDays: null }),
  ...
  },
  {
    ...
    defaultRules: () => ({ type: 'bundle', totalUses: 10, label: 'clases', expiresInDays: null }),
    previewData: (rules) => {
  ...
  },
  {
    ...
    defaultRules: () => ({ type: 'giftcard', initialBalance: 500, currency: 'MXN', expiresInDays: null }),
    previewData: (rules) => {
